...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validate = __webpack_require__(157);

	var _NumberInputJsx = __webpack_require__(160);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(_NumberInputJsx2['default'], { validationTimeoutSeconds: 0.4, validFunction: _validate.isValidNumber })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.convertToRawNumber = convertToRawNumber;
	...
	function isValid(s) {
	    if (_data.data[s]) return true;else return false;
	}
	...
	function digitsAfterDecimal(numStr) {
	...
	function convertToRawNumber(value) {
	    ...
	    var ext = vs[1];
	    var rawNumber = numStr + repeat('0', _data.data[ext] - digitsAfterDecimal(numStr));
	    return rawNumber;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RawNumberJsx = __webpack_require__(161);

	var _RawNumberJsx2 = _interopRequireDefault(_RawNumberJsx);
	    ...
	    _createClass(NumberInput, [{
	        ...
	        value: function handleChange(event) {
	            ...
	            if (isValid === false) {
	                ...
	                this.timeout.push(setTimeout((function () {
	                    this.setValidity('invalid');
	                }).bind(this), this.props.validationTimeoutSeconds * 1000));
	            } else {
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', className: this.getClassName(), value: this.state.value, onChange: this.handleChange.bind(this), placeholder: 'Enter a number' }),
	                React.createElement(_RawNumberJsx2['default'], { isValid: this.state.isValid, value: this.state.value })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RawNumber = (function (_React$Component) {
	    function RawNumber() {
	        _classCallCheck(this, RawNumber);
	    ...
	    _inherits(RawNumber, _React$Component);

	    _createClass(RawNumber, [{
	        key: 'render',
	        value: function render() {
	            if (this.props.isValid) {
	                var rawNumber = (0, _functions.convertToRawNumber)(this.props.value);
